...
def _from_csv_v3(csvfile):
    ...
    try:
        ...
        raise RuntimeError("CSV metadata is incomplete. Expected four metadata rows before the data table.") from exc
...
def _to_csv_v3(collection: mammos_entity.EntityCollection, filename: os.PathLike) -> None:
    """Write EntityCollection into mammos csv v3 format."""
